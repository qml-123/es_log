...
var _ = es_log.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  SearchResponse Search(SearchRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := es_log.NewLogServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Search":
    ...
    value0 := argvalue0
    fmt.Print(client.Search(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
